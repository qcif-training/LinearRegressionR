...
```
## Error in data[, c("ID", "trestbps", signfic_res_or_close)]: object of type 'closure' is not subsettable
```
...
```
## Error in eval(expr, envir, enclos): object 'newdataset' not found
```
...
```
## Error in is.data.frame(data): object 'newdataset' not found
```
...
```
## Error in terms(object): object 'result' not found
```
...
```
## Error in summary(finalmodel): object 'finalmodel' not found
```
...
```
## Error in plot(finalmodel): object 'finalmodel' not found
```
...
```
## Error in car::vif(finalmodel): object 'finalmodel' not found
```
...
```
## Error in data[, Select]: object of type 'closure' is not subsettable
```
...
```
## Error in eval(expr, envir, enclos): object 'select_data' not found
```
...
```
## Error in is.data.frame(data): object 'select_data' not found
```
...
```
## Error in anova(result2): object 'result2' not found
```
...
```
## Error in summary(result2): object 'result2' not found
```
...
```
## Error in car::vif(result2): object 'result2' not found
```
...
```
## Error in plot(result2): object 'result2' not found
```
...
```
## Warning in file(file, "rt"): cannot open file 'Plasma.csv': No such file or
## directory
```
...
```
## Error in str(plasma): object 'plasma' not found
```
...
```
## Error in is.factor(x): object 'plasma' not found
```
...
```
## Error in levels(plasma$sex) <- c("Male", "Female"): object 'plasma' not found
```
...
```
## Error in levels(plasma$smokstat) <- c("Never", "Former", "Current"): object 'plasma' not found
```
...
```
## Error in levels(plasma$vituse) <- c("Often", "notoften", "No"): object 'plasma' not found
```
...
```
## Error in summary(plasma): object 'plasma' not found
```
...
```
## Error in hist(plasma$betaplasma): object 'plasma' not found
```
...
```
## Error in stopifnot(is.numeric(x)): object 'plasma' not found
```
...
```
## Error in eval(expr, envir, enclos): object 'plasma' not found
```
...
```
## Error in hist(plasma$logbetaplasma): object 'plasma' not found
```
...
```
## Error in lapply(X = X, FUN = FUN, ...): object 'plasma' not found
```
...
```
## Error in is.data.frame(y): object 'plasma' not found
```
...
```
## Error in eval(predvars, data, env): object 'plasma' not found
```
...
```
## Error in is.data.frame(x): object 'plasma' not found
```
...
```
## Error in summary(initial_result): object 'initial_result' not found
```
...
```
## Error in terms(object): object 'initial_result' not found
```
...
```
## Error in summary(finalmodel_raw): object 'finalmodel_raw' not found
```
...
```
## Error in plot(finalmodel_raw): object 'finalmodel_raw' not found
```
...
```
## Error in na.omit(plasma): object 'plasma' not found
```
...
```
## Error in data$Patient.ID: object of type 'closure' is not subsettable
```
...
```
## Error in data$betaplasma: object of type 'closure' is not subsettable
```
...
```
## Error in model.frame.default(formula = logbetaplasma ~ age + quetelet + : 'data' must be a data.frame, environment, or list
```
...
```
## Error in terms(object): object 'finalmodel' not found
```
